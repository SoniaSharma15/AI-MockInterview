...
function InterviewItemCard({interview}) {
  ...
  const onStart=()=>{
    router.push("/softSkills/interview/"+interview?.mockId)
  }
  const onFeedbackPress=()=>{
    router.push("/softSkills/interview/"+interview?.mockId+"/feedback")
  }
  return (
    ...
    <h2 className='font-bold text-gray-600 truncate'>{interview?.skillBasedOrNot}</h2>
